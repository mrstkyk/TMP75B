...
float TMP75B_getTemperature(I2C_HandleTypeDef i2c)
{
      ...
      HAL_I2C_Master_Transmit(&i2c,TMP75B_DeviceID<<1,buf,1,100);
      HAL_Delay(1);
      HAL_I2C_Master_Receive(&i2c,TMP75B_DeviceID<<1,buf,2,100);
...
void TMP75B_setConfiguration(I2C_HandleTypeDef i2c)
{
    ...
    HAL_I2C_Master_Transmit(&i2c,TMP75B_DeviceID<<1,buf,3,100);
}
